...
export const updateSearchBar = (name, value) => ({
    'type': action.UPDATE_SEARCH_BAR,
    name, value
});

export const clearSearchBar = () => ({
    'type': action.CLEAR_SEARCH_BAR
});

export const unloadSearchBar = () => ({
    'type': action.UNLOAD_SEARCH_BAR
});
